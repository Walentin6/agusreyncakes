...
import { onRequestDelete as __api_admin_combos_js_onRequestDelete } from "C:\\Users\\vlen0\\Desktop\\CLIENTES\\agusreyncakes\\functions\\api\\admin\\combos.js"
import { onRequestGet as __api_admin_combos_js_onRequestGet } from "C:\\Users\\vlen0\\Desktop\\CLIENTES\\agusreyncakes\\functions\\api\\admin\\combos.js"
import { onRequestPost as __api_admin_combos_js_onRequestPost } from "C:\\Users\\vlen0\\Desktop\\CLIENTES\\agusreyncakes\\functions\\api\\admin\\combos.js"
import { onRequestPut as __api_admin_combos_js_onRequestPut } from "C:\\Users\\vlen0\\Desktop\\CLIENTES\\agusreyncakes\\functions\\api\\admin\\combos.js"
...
import { onRequestGet as __api_admin_trash_js_onRequestGet } from "C:\\Users\\vlen0\\Desktop\\CLIENTES\\agusreyncakes\\functions\\api\\admin\\trash.js"
...
import { onRequestPatch as __api_recipes__id__js_onRequestPatch } from "C:\\Users\\vlen0\\Desktop\\CLIENTES\\agusreyncakes\\functions\\api\\recipes\\[id].js"
...
import { onRequestGet as __api_combos_index_js_onRequestGet } from "C:\\Users\\vlen0\\Desktop\\CLIENTES\\agusreyncakes\\functions\\api\\combos\\index.js"
...
export const routes = [
    ...
    },
  {
      ...
      method: "DELETE",
      middlewares: [],
      modules: [__api_admin_combos_js_onRequestDelete],
    },
  {
      routePath: "/api/admin/combos",
      mountPath: "/api/admin",
      method: "GET",
      middlewares: [],
      modules: [__api_admin_combos_js_onRequestGet],
    },
  {
      routePath: "/api/admin/combos",
      mountPath: "/api/admin",
      method: "POST",
      middlewares: [],
      modules: [__api_admin_combos_js_onRequestPost],
    },
  {
      routePath: "/api/admin/combos",
      mountPath: "/api/admin",
      method: "PUT",
      middlewares: [],
      modules: [__api_admin_combos_js_onRequestPut],
    },
  {
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_admin_trash_js_onRequestGet],
    },
  {
    ...
    },
  {
      ...
      method: "PATCH",
      middlewares: [],
      modules: [__api_recipes__id__js_onRequestPatch],
    },
  {
      routePath: "/api/recipes/:id",
      mountPath: "/api/recipes",
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_combos_index_js_onRequestGet],
    },
  {
