import { onRequestGet as __api_recipes__id__images_images_js_onRequestGet } from "C:\\Users\\vlen0\\Desktop\\CLIENTES\\agusreyncakes\\functions\\api\\recipes\\[id]\\images\\images.js"
import { onRequestPost as __api_recipes__id__images_images_js_onRequestPost } from "C:\\Users\\vlen0\\Desktop\\CLIENTES\\agusreyncakes\\functions\\api\\recipes\\[id]\\images\\images.js"
...
export const routes = [
    {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_recipes__id__images_images_js_onRequestGet],
    },
  {
      routePath: "/api/recipes/:id/images/images",
      mountPath: "/api/recipes/:id/images",
      method: "POST",
      middlewares: [],
      modules: [__api_recipes__id__images_images_js_onRequestPost],
    },
  {
